...
M.anime_selector = image_selector("< Anime Bobs > ", "~/.config/personal/backgrounds")
...
M.dev = function(opts)
	...
	if not ok then
		print("===================================================")
		print("HEY DUFUS. YOUR CODE DOESNT WORK. THIS IS NOT ON ME")
		print("===================================================")
		return
	end
	...
	if #mod_name ~= 2 then
		print("===================================================")
		print("HEY DUFUS. I DO NOT KNOW HOW TO FIND THIS FILE:")
		print(dev)
		print("===================================================")
	end
